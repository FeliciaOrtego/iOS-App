//
//  GWSPushNotificationSender.swift
//  DatingApp
//
...
class GWSPushNotificationSender {
    ...
    func sendPushNotification(token: String, title: String, body: String, notificationType: GWSNotificationType, payload: [String: String]) {
        var data = payload
