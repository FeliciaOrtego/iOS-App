...
final class YPCropView: UIView {
    ...
    convenience init(image: UIImage) {
        ...
        case let .rectangle(ratio: configuredRatio):
    ...
    private func setupLayout(with _: UIImage, ratio: Double) {
        ...
        let complementRatio = CGFloat(1.0 / ratio)
    ...
    private func setupImage(_ image: UIImage, with ratio: Double) {
        ...
        let imageRatio = Double(image.size.width / image.size.height)
        if ratio > imageRatio {
